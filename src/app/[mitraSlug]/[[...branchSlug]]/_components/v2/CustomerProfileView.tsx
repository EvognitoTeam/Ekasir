...
export default function ProfileView({
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center bg-stone-50">
  ...
  return (
    <div className="min-h-full bg-stone-50 pb-32 pt-6">
      <LegalModal
      ...
      <header className="mb-7 px-4">
        ...
        >
          <div className="h-[2px] w-8 rounded-full bg-black" />
          <span className="font-label text-[10px] font-bold uppercase tracking-[0.3em] text-black">
            Profil & Pengaturan
          </span>
        </motion.div>

        <h1 className="text-[34px] font-black leading-[0.98] tracking-[-0.055em] text-neutral-950">
          Profil.
        </h1>
      </header>
        ...
        <AnimatePresence mode="wait">
          {isLoggedIn ? (
            <motion.section
              ...
              exit={{ opacity: 0, y: -12 }}
              className="relative overflow-hidden rounded-[28px] border border-black bg-black p-6 text-white shadow-lg"
            >
              <div className="pointer-events-none absolute -mr-20 -mt-20 right-0 top-0 h-64 w-64 rounded-full bg-black opacity-20 blur-3xl mix-blend-overlay" />
              ...
              <div className="relative z-10 flex flex-col gap-6">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex min-w-0 flex-1 items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h2 className="truncate font-sans text-2xl text-white">
                ...
                <div className="grid grid-cols-2 gap-3 border-t border-white/10 pt-6">
                  <div className="rounded-xl border border-white/5 bg-white/5 p-3 text-center backdrop-blur-sm sm:p-4">
                    <p className="font-sans text-xl text-white sm:text-2xl">
                  ...
                  <div className="rounded-xl border border-white/5 bg-white/5 p-3 text-center backdrop-blur-sm sm:p-4">
                    <p className="truncate font-sans text-sm text-white sm:text-lg">
                  ...
                  <div className="border-b border-white/10 px-5 py-4">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <h3 className="mt-1 flex items-center gap-2 font-sans text-lg font-bold text-white">
                      ...
                      <div className="rounded-xl border border-amber-400/20 bg-amber-400/10 px-4 py-3 text-right">
                        ...
                        <p className="mt-1 font-sans text-2xl font-bold text-amber-300">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-stone-100 px-8 py-5">
                <p className="font-label text-[10px] font-bold uppercase tracking-[0.2em] text-black">
                ...
                <button
                  ...
                  className="text-[10px] font-bold uppercase tracking-wider text-stone-400 transition-colors hover:text-black"
                >
              ...
              {authMode === 'login' ? (
                <form className="flex flex-col gap-5 p-8" onSubmit={handleLogin}>
                  <div>
                    <h2 className="font-sans text-2xl font-medium text-stone-900">
                  ...
                  <button
                    ...
                    className="mt-1 flex w-full items-center justify-center gap-2 rounded-xl bg-black py-3.5 font-label text-xs font-bold uppercase tracking-widest text-white transition-all hover:brightness-95 active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-stone-300"
                  >
                    {isSubmitting ? (
        ...
        {items.map((item, index) => (
          ...
          >
            <div className="flex min-w-0 items-center gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-stone-50 text-stone-400 transition-all group-hover:bg-black/10 group-hover:text-black">
            ...
            <ChevronRight className="h-4 w-4 shrink-0 text-stone-300 transition-colors group-hover:text-black" />
          </button>
        ))}
      </div>
    </motion.section>
    ...
    <label className="flex flex-col gap-1.5">
      ...
      <span className="relative block">
        ...
        <input
          ...
          required
          className="w-full rounded-xl border border-stone-200/60 bg-stone-100/50 py-3 pl-11 pr-4 text-base text-stone-800 outline-none transition-all placeholder:text-stone-400 focus:border-black focus:ring-2 focus:ring-[var(--color-primary)]/20"
        />
      </span>
    </label>
  );
          ...
          >
            <div className="flex items-center justify-between border-b border-stone-100 bg-stone-50/50 px-6 py-5">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-black/10 text-black">
            ...
            <div className="border-t border-stone-100 bg-white p-5">
              <button
                type="button"
                onClick={onClose}
                className="w-full rounded-xl bg-black py-3.5 font-label text-xs font-bold uppercase tracking-widest text-white transition-all hover:brightness-95 active:scale-[0.98]"
              >
                {buttonLabel}
              </button>
            </div>
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p className="font-label text-[10px] font-bold uppercase tracking-[0.28em] text-black">
              Kartu Member Digital
            </p>
            <h3 className="mt-2 font-sans text-2xl font-bold text-stone-900">
              Pindai QR Member
            </h3>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 text-left">
              ...
              <div className="rounded-2xl bg-stone-900 p-4 text-white">
                ...
                <p className="mt-1 font-sans text-xl font-bold">{points}</p>
              </div>
            </div>
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-5 w-full rounded-xl bg-black py-3.5 font-label text-xs font-bold uppercase tracking-widest text-white transition-all hover:brightness-95 active:scale-[0.98]"
            >
              Tutup
            </button>
          </motion.div>
