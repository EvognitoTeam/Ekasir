...
export default function OrderHistoryView({
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f7f7f5]">
        <Loader2 className="w-10 h-10 text-[#111111] animate-spin mb-4" />
      ...
      <div className="min-h-screen bg-[#f7f7f5] px-6 py-12">
        <div className="mx-auto flex max-w-md flex-col items-center rounded-[2rem] border border-amber-200 bg-white p-8 text-center shadow-sm">
          ...
          <button
            ...
            className="rounded-full bg-[#111111] px-7 py-3 text-[10px] font-bold uppercase tracking-widest text-white"
          >
            Kembali ke Menu
          </button>
        </div>
  ...
  return (
    <div className="min-h-full bg-stone-50 px-4 pb-32 pt-6 font-sans">
      <header className="mb-8">
        ...
        >
          ...
          <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#111111]">
            The Discovery Ledger
          </span>
        </motion.div>

        <h1 className="mb-6 text-[34px] font-black leading-[0.98] tracking-[-0.055em] text-neutral-950">
          Experience Archive.
        </h1>
          ...
          {[
            ...
            (stat) => (
              <div
                ...
                className="flex flex-col gap-3 rounded-[22px] border border-black/[0.07] bg-white p-4"
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-black text-white">
                  <stat.icon className="w-4 h-4 text-[#111111]" />
                </div>
      ...
      <div className="mb-6 flex rounded-2xl bg-stone-200 p-1">
        <button
          type="button"
          onClick={() =>
            setActiveTab(
                  ...
                  (
                    ...
                    return (
                      <motion.div
                        ...
                        className="relative flex flex-col gap-5 overflow-hidden rounded-[28px] bg-black p-5 text-white shadow-lg"
                      >
                        ...
                        <button
                          ...
                          className="w-full bg-[#111111] hover:bg-emerald-500 text-white flex items-center justify-between px-8 py-4 rounded-xl transition-all group relative z-10"
                        >
      ...
      <div className="mt-20 text-center pb-10">
        <button
          ...
          className="px-10 py-4 bg-white border border-stone-200 rounded-full text-[10px] font-bold uppercase tracking-widest text-stone-400 hover:text-[#111111] transition-all active:scale-95 shadow-sm"
        >
          Return to Menu
        </button>
      </div>
