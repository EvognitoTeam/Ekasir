...
export default function OrderTrackingView({ onBackToMenu, onViewRoasts }: Props) {
  ...
  if (!currentOrder) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center bg-[#f7f7f5]">
        ...
        <button onClick={onBackToMenu} className="px-10 py-4 border border-stone-200 rounded-full text-[10px] font-bold uppercase tracking-widest text-stone-600 hover:bg-[#111111] hover:text-white hover:border-[#111111] transition-all">
          Retrieve The Menu
        </button>
      </div>
    );
  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-stone-50 px-4 pb-32 pt-6 font-sans text-neutral-950">
      <div className="pointer-events-none absolute inset-0">
         <div className="absolute top-0 right-0 w-[80vw] h-[80vw] bg-[#111111] opacity-[0.02] blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2" />
      ...
      <main className="px-6 py-12 relative z-10 max-w-[480px] mx-auto pb-32">
        <header className="mb-8 flex flex-col items-start gap-5">
           <div className="space-y-6 w-full">
              <motion.button 
                ...
                className="flex items-center gap-3 text-stone-500 hover:text-[#111111] transition-colors group"
              >
              ...
              <div className="space-y-2">
                 <div className="flex items-center justify-between w-full mb-6">
                    <div className="px-3 py-1 bg-emerald-50 text-[#111111] border border-[#111111]/20 rounded-full text-[9px] font-bold uppercase tracking-widest flex items-center gap-2">
           ...
           <div className="flex w-full flex-col items-start gap-2">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <p className="text-4xl font-black text-[#111111] uppercase">
                  {stationLabel}
                </p>
        ...
        <AnimatePresence>
          {isUnpaidQris && (
            <motion.div
              ...
              className="mb-12 overflow-hidden"
            >
              <div className="relative rounded-[28px] border border-black/[0.08] bg-white p-5 shadow-sm">
                <div className="absolute top-0 right-0 bg-[#111111] text-white px-4 py-1 rounded-bl-xl font-bold text-[10px] uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="mt-4 flex flex-col items-center text-center">
                  ...
                  <div className="bg-emerald-50 px-6 py-3 rounded-xl border border-emerald-200">
                    <p className="text-[10px] font-bold text-[#111111] uppercase tracking-widest mb-1">
                      Order Code
                    </p>

                    <p className="text-2xl font-black text-[#111111] tracking-widest">
                      {orderCodeToDisplay}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex flex-col gap-12">
           <div className="w-full">
              <div className="relative ml-2 space-y-8 border-l border-black/10 pl-8">
                 {STEPS.map((step, index) => {
                   ...
                   return (
                     ...
                     >
                       {isCurrent && (
                         <div className="absolute -left-[14px] top-0 bottom-0 w-[4px] bg-[#111111] shadow-[0_0_10px_rgba(14,92,55,0.5)] -translate-y-12 h-24 rounded-full" />
                       )}
                       ...
                       <div className={`absolute -left-[32px] w-12 h-12 rounded-full flex items-center justify-center transition-all duration-700 z-20 ${
                         isPast 
                           ...
                           : isCurrent
                             ? 'bg-white border-4 border-[#111111] text-[#111111] shadow-xl scale-110'
                         ...
                         {isCurrent && (
                           <motion.div 
                             className="absolute inset-0 rounded-full bg-[#111111] opacity-20 blur-md"
                       ...
                       <div className="flex flex-col items-start gap-2 pl-6">
                          <div className="space-y-1">
                             <div className="flex items-center gap-3">
                                <h3 className={`text-xl font-bold tracking-tight ${isCurrent ? 'text-[#111111]' : 'text-stone-800'}`}>
                                  {step.label}
                                </h3>
                                {isCurrent && (
                                   <div className="flex items-center gap-1.5">
                                      <span className="w-6 h-px bg-[#111111] opacity-40" />
                                      <Zap className="w-3 h-3 text-[#111111] animate-pulse" />
                                   </div>
                                )}
                             </div>
           ...
           <div className="w-full space-y-6">
              <div className="bg-white rounded-3xl p-8 border border-stone-100 shadow-sm relative overflow-hidden group">
                 ...
                 <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                       <span className="text-[10px] font-bold text-[#111111] uppercase tracking-widest">Kitchen Message</span>
                    ...
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 rounded-full bg-emerald-100 border border-emerald-200 flex items-center justify-center text-[#111111]">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div onClick={onViewRoasts ?? onBackToMenu} className="bg-stone-50 rounded-3xl p-6 flex flex-col justify-between aspect-square group hover:bg-[#111111] hover:text-white transition-all duration-300 cursor-pointer border border-stone-100 shadow-sm">
                    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:bg-white/20">
                       <Sparkles className="w-5 h-5 text-[#111111] group-hover:text-white transition-colors" />
                    </div>
                    <div>
                 ...
                 <div onClick={onBackToMenu} className="bg-[#111111] text-white rounded-3xl p-6 flex flex-col justify-between aspect-square group hover:scale-[1.02] transition-all cursor-pointer shadow-lg shadow-black/10">
