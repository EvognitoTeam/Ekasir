...
bool buzzerReadyActive = false;
bool buzzerTonePlaying = false;
unsigned long buzzerPatternStartedAt = 0;
unsigned int buzzerCurrentFrequency = 0;
 ...
 * 580  - 1900ms : OFF
 *
 * Non-blocking: tidak ada delay() di dalam pattern buzzer,
 * sehingga WebSocket, LED, dan display tetap responsif.
 */
void handleBuzzer() {
  const bool shouldBuzz =
    wsOk &&
    authOk &&
    (
      pagerActive ||
